...
const Details = () => {
  ...
  // Check if movie is saved when component mounts or movie data changes
  useEffect(() => {
    ...
    <View className="bg-primary flex-1">
      <ScrollView contentContainerStyle={{ paddingBottom: 80 }}>
        <View>
          ...
          <TouchableOpacity
            className="absolute bottom-5 right-24 rounded-full size-14 bg-accent flex items-center justify-center"
